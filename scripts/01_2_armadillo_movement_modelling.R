...
for(j in 1:length(DATA)){
  ...
  if(j == 1){
    ...
    write.table(RESULTS,
                file = "~/Dropbox/UBC/Projects/microplastics_brazil/data/movement_summaries/armadillo_movement_summary.csv",
                row.names=FALSE,
                col.names=TRUE,
                sep=",")
...
write.table(res,
            file = "~/Dropbox/UBC/Projects/microplastics_brazil/data/movement_summaries/armadillo_land_use_summary.csv",
            row.names=FALSE,
            col.names=TRUE,
            sep=",")
