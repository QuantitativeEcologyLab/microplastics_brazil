# This script generates figure 4 in the main text that
...
#---------------------------------------------------------------------
# Figure 4A - heatmap of polymer abundances
#---------------------------------------------------------------------
...
ggsave(a,
       ...
       dpi = 600,
       bg = "transparent",
       file="figures/figure_4_left.png")


#---------------------------------------------------------------------
# Figure 4B -D - Radar plots of polymer abundances in each biome
#---------------------------------------------------------------------
...
png(filename = "figures/figure_4_right.png",
    width = 2.375, height = 5, units = "in",
    bg = "transparent",
    res = 600)
